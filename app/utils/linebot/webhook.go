...
// ParseRequest method
func (client *Client) ParseRequest(r *fasthttp.Request) ([]*Event, error) {
	return ParseRequest(client.channelSecret, r)
}

// ParseRequest func
func ParseRequest(channelSecret string, r *fasthttp.Request) ([]*Event, error) {
	defer r.Body()
	body := r.Body()

	if !validateSignature(channelSecret, string(r.Header.Peek("X-Line-Signature")), body) {
